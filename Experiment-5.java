...
System.out.println("Enter Text: ");
 ...
 c.init(Cipher.ENCRYPT_MODE, key); byte[] enc = c.doFinal(msg.getBytes()); System.out.println("Encrypted: " + Base64.getEncoder().encodeToString(enc)); c.init(Cipher.DECRYPT_MODE, key);
